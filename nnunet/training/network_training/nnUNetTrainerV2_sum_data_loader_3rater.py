...
import SimpleITK
from nnunet.training.dataloading.dataset_loading_multirater_sampling import DataLoader3D_major, unpack_dataset,load_dataset_multi_rater
...
class nnUNetTrainerV2_sum_data_loader_3rater(nnUNetTrainerV2):
    ...
    def get_basic_generators(self):
        ...
        self.print_to_log_file("Training on the sum of rater: ", self.sum_mode )

        dl_tr = DataLoader3D_major(self.dataset_tr, self.patch_size, self.patch_size, self.batch_size, False,
                                  oversample_foreground_percent=self.oversample_foreground_percent,
                                  pad_mode="constant", pad_sides=self.pad_all_sides, memmap_mode='r', sum_mode=self.sum_mode)
