...
import SimpleITK
from nnunet.training.dataloading.dataset_loading_majority_sampling import DataLoader3D_major
...
class nnUNetTrainerV2_majority_data_loader_3rater(nnUNetTrainerV2_multi_rater_data_loader):
